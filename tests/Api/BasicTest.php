...
class BasicTest extends BaseApiTestCase
{
    ...
    public function testCountry()
    {
        ...
        // country list
        $localizedCountryList = \Opensmarty\Model\Basic\CountryModel::getLocalizedCountryList();
        print_r($localizedCountryList);

        // country list
        $countryInfoIndexedList = \Opensmarty\Model\Basic\CountryModel::getCountryInfoIndexedList();
