...
// Image Routes
// @WARNING: The 'image' prefix is reserved for OpensmartyImageService
...
// Locale Routes
// @WARNING: The 'locales' prefix is reserved for OpensmartyLocaleController
Route::group(['prefix' => 'locales'], function () {

    Route::get('/{locale}.js', '\Opensmarty\Support\Controllers\LocaleController@getLocaleJs');

    Route::get('/switch/{locale}', '\Opensmarty\Support\Controllers\LocaleController@getSwitchLocale');
